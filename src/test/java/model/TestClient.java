...
public class TestClient {
    ...
    public void testModification() throws SQLException{
        ...
        ClientEntity c2 = new ClientEntity("AROUT","Pomme","Thomas Hardy","Représentant(e)","120 Hanover Sq.","London",null,"WA1 1DP","Royaume-Uni","(71) 555-7788","(71) 555-6750");
        ClientEntity c3 = dao.rechercheCompte("Thomas Hardy", "AROUT");
        assertEquals(c3.toString(), c2.toString() );
    }
}

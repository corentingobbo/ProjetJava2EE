 ...
 * @author pedago
 */
@WebServlet(name = "tousLesProduitsSony", urlPatterns = {"/tousLesProduitsSony"})
public class tousLesProduitsSony extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		Properties resultat = new Properties();
                ...
                try {
                    resultat.put("produits", dao.rechercheProduitSony());
                }catch (Exception ex) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(tousLesProduitsSony.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

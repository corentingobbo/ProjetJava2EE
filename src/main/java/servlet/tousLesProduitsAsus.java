 ...
 * @author pedago
 */
@WebServlet(name = "tousLesProduitsAsus", urlPatterns = {"/tousLesProduitsAsus"})
public class tousLesProduitsAsus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		Properties resultat = new Properties();
                ...
                try {
                    resultat.put("produits", dao.rechercheProduitAsus());
                }catch (Exception ex) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(tousLesProduitsAsus.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

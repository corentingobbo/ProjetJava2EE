 ...
 * @author Corentin
 */
@WebServlet(name = "FiltrePhones", urlPatterns = {"/FiltrePhones"})
public class FiltrePhones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		Properties resultat = new Properties();
                ...
                String marque = request.getParameter("Apple");
                String test = "test";
                try {
                    resultat.put("produits", marque);
                }catch (Exception ex) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FiltrePhones.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

 ...
 * @author pedago
 */
@WebServlet(name = "tousLesProduitsOppo", urlPatterns = {"/tousLesProduitsOppo"})
public class tousLesProduitsOppo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		Properties resultat = new Properties();
                ...
                try {
                    resultat.put("produits", dao.rechercheProduitOppo());
                }catch (Exception ex) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(tousLesProduitsOppo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
